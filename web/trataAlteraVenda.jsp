<%-- 
    ...
    Created on : 25/11/2016, 20:42:42
    Author     : Guilherme
--%>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
            ...
            <%
                ...
                if (user == null) {
                    ...
                    String dt_pagto = request.getParameter("data_pagto");
                    double valor = Double.parseDouble(request.getParameter("valor_pagto"));

                    Venda ven = new Venda();

                    ven.setCliCodigo(cliente);
                    ven.setCep(cep);
                    ven.setProCodigo(produto);
                    ven.setData(data);
                    ven.setDataPagto(dt_pagto);
                    ven.setQtdVenda(qtd);
                    ven.setValorPagto(valor);

                    boolean alterou = VendaDB.alteraVenda(ven);
                    ...
                    if (alterou) {
                        ...
                        out.println("</svg> Venda alterado com sucesso!");
                        ...
                        out.println("</svg> Erro na alteração da venda!");
                        out.println("<a href=\"listaVenda.jsp\" class=\"pull-right\">");
                        out.println("<span class=\"glyphicon glyphicon-remove\"></span>");
                        out.println("</a>");
                        out.println("</div>");
