...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="tables.jsp"><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use></svg> Tables</a></li>
			...
			<li class="active"><a href="icons.jsp"><svg class="glyph stroked star"><use xlink:href="#stroked-star"></use></svg> Icons</a></li>
			<li class="parent ">
				<a href="#">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="icon-grid">
							...
							<div class="col-lg-3 col-md-4 col-sm-6">
								<svg class="glyph stroked desktop computer e mobile"><use xlink:href="#stroked-desktop-computer-and-mobile"/></svg>
							...
							<div class="col-lg-3 col-md-4 col-sm-6">
								<svg class="glyph stroked laptop computer e mobile"><use xlink:href="#stroked-laptop-computer-and-mobile"/></svg>
